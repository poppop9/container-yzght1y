...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yzght1y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yzght1y.containers.anotherwebservice.com/
...
```
git clone git@github.com:poppop9/container-yzght1y.git
cd container-yzght1y
```
...
```
docker attach container-yzght1y
```
